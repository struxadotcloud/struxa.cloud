  ...
  return (
    <section className="relative">
      <div className="max-w-xl px-6 py-14 pb-16 md:max-w-2xl md:px-16">
        <p className="text-xs uppercase tracking-wide text-blue-500">Managed</p>
      ...
      <div className="mx-6 mb-6 w-auto border border-neutral-800 bg-neutral-950 md:absolute md:bottom-0 md:right-0 md:mx-0 md:mb-0 md:w-80 md:border-b-0 md:border-r-0">
        <div className="border-b border-neutral-800 px-5 py-4">
          <p className="text-xs uppercase tracking-wide text-blue-500">Struxa Cloud</p>
        ...
        <ul className="space-y-2 px-5 py-4 text-[11px] text-neutral-400">
          {[
            'Panel hosted by us',
            'Automatic updates',
